<template>
    <div>
        <NewTaskDaily></NewTaskDaily>

        <TaskStage v-show="runningHosts.length" :source="1" class="my-4"></TaskStage>

        <TaskHistory class="mt-4" :source="1"></TaskHistory>
    </div>
</template>

<script setup>
import NewTaskDaily from '~/components/panel/NewTaskDaily.vue';
